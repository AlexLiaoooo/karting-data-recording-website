...
const zh: Record<string, string> = {
  ...
  "Create PF International": "建立 PF International",
  ...
  "PF International created with a built-in map": "已建立 PF International，并载入内置地图",
  "PF International created — upload your map image next": "已建立 PF International，请接着上传地图图片",
