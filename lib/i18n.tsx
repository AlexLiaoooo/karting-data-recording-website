...
const zh: Record<string, string> = {
  ...
  "Pressure gain here": "这里的胎压增量",
  "Past gain here in the {condition} · {runs}": "这里过往的胎压增量（{condition}）· {runs}",
  "Nearest in track temperature: {temperature} °C at {where}, front {front}, rear {rear}": "赛道温度最接近的一次：{temperature} °C，{where}，前轮 {front}，后轮 {rear}",
  "From past Runs here; not a recommendation.": "来自这里的过往 Run，并非推荐值。",
  "Cold-to-hot pressure gain from past Runs here. It describes what happened; it does not recommend a pressure.": "来自这里过往 Run 的冷热胎压增量。这里只描述发生过的情况，不推荐具体胎压。",
  "front {value} psi": "前轮 {value} psi",
  "rear {value} psi": "后轮 {value} psi",
  "front {min} to {max} psi · mean {mean}": "前轮 {min} 至 {max} psi · 平均 {mean}",
  "rear {min} to {max} psi · mean {mean}": "后轮 {min} 至 {max} psi · 平均 {mean}",
  "front {front} · rear {rear}": "前轮 {front} · 后轮 {rear}",
  "best {lap}": "最快 {lap}",
